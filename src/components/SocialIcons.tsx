...
// WhatsApp glyph (lucide-react has no built-in WhatsApp icon).
...
export type SocialLink = {
  label: "Instagram" | "LinkedIn" | "Facebook" | "WhatsApp" | "Pinterest";
  href: string;
};

const iconFor = (label: SocialLink["label"]) => {
